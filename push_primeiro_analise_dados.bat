@echo off
REM =======================================================
REM Subir um diretório local ao GitHub (1ª vez)
REM Usuário: evandromelo
REM Email:   evandro.cm@gmail.com
REM Repo:    https://github.com/evandromelo/analise_dados.git
REM =======================================================
...
git remote add origin https://github.com/evandromelo/analise_dados.git
